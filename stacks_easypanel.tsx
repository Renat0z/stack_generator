...
DATABASE_CONNECTION_URI=postgres://postgres:${formData.postgresPassword}@${formData.projectName}_postgres:5432/${formData.projectName}
CACHE_REDIS_ENABLED=true
CACHE_REDIS_URI=redis://default:${formData.redisPassword}@${formData.projectName}_redis:6379
S3_ENABLED=true
S3_ACCESS_KEY=${formData.minioRootUser}
S3_SECRET_KEY=${formData.minioRootPassword}
S3_BUCKET=evolution
...
S3_REGION=us-east-1
S3_USE_SSL=true
AUTHENTICATION_API_KEY=${generateRandomString()}`;
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="projectName" value={formData.projectName} onChange={e => setFormData(prev => ({ ...prev, projectName: e.target.value }))} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="n8nEditorDomain">N8n Editor Domain</Label>
              <Input id="n8nEditorDomain" value={formData.n8nEditorDomain} onChange={e => setFormData(prev => ({ ...prev, n8nEditorDomain: e.target.value }))} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="n8nWebhookDomain">N8n Webhook Domain</Label>
              <Input id="n8nWebhookDomain" value={formData.n8nWebhookDomain} onChange={e => setFormData(prev => ({ ...prev, n8nWebhookDomain: e.target.value }))} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="difyDomain">Dify Domain</Label>
              <Input id="difyDomain" value={formData.difyDomain} onChange={e => setFormData(prev => ({ ...prev, difyDomain: e.target.value }))} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="evolutionDomain">Evolution Domain</Label>
              <Input id="evolutionDomain" value={formData.evolutionDomain} onChange={e => setFormData(prev => ({ ...prev, evolutionDomain: e.target.value }))} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="minioDomain">MinIO Domain</Label>
              <Input id="minioDomain" value={formData.minioDomain} onChange={e => setFormData(prev => ({ ...prev, minioDomain: e.target.value }))} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="minioConsoleDomain">MinIO Console Domain</Label>
              <Input id="minioConsoleDomain" value={formData.minioConsoleDomain} onChange={e => setFormData(prev => ({ ...prev, minioConsoleDomain: e.target.value }))} />
            </div>
          </div>

          <div className="pt-4">
            <Button onClick={generatePasswords} className="mb-4">Regenerate Passwords</Button>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label>Redis Password</Label>
                <div className="flex gap-2">
                  <Input value={formData.redisPassword} readOnly />
                  <Button size="icon" variant="outline" onClick={() => copyToClipboard(formData.redisPassword, 'redis', 'Senha do Redis')}>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button size="icon" variant="outline" onClick={() => copyToClipboard(formData.postgresPassword, 'postgres', 'Senha do PostgreSQL')}>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button size="icon" variant="outline" onClick={() => copyToClipboard(formData.encryptionKey, 'encryption', 'Chave de Criptografia')}>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button size="icon" variant="outline" onClick={() => copyToClipboard(formData.minioRootPassword, 'minioRootPassword', 'Senha do MinIO')}>
